...
## 🌍 Selected Freelance Portfolio

## 🌍 Selected Freelance Portfolio

### 🏘️ Eboni One — RT/RW Digital Application

Web-based application for RT/RW community administration, including community dues and operational management.

Currently developing payment integration using **Midtrans Payment Gateway**.

**Project:** https://ebonione.com/login

---

### 🚒 Fire Truck Automation

Desktop application developed for fire department operational needs.

The application automates structured data processing from **WhatsApp to Google Sheets**, helping operational data received through WhatsApp to be recorded into Google Spreadsheet automatically.

**Type:** Desktop Application  
**Integration:** WhatsApp → Google Sheets

---

### Digi Kreatif Studio Apps
